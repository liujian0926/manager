...
<template>
  <div class="users-container">
    <!-- 头部面包屑 -->
    <my-break sectitle="商品管理" threetitle='商品分类'></my-break>
    ...
    <el-row>
      ...
      <!-- 按钮 -->
      <el-col :span="6">
        <el-button type="success" plain class="btn-add" >添加商品</el-button>
      </el-col>
    </el-row>
    ...
    <el-table :data="cateList" style="width: 100%" border>
      ...
      <el-table-column prop="email" label="是否有效" width="180"></el-table-column>
